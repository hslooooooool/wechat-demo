...
object BottomDialogUtils {
    ...
    init {
        fileOperation.add(Operation(R.drawable.icon_take_photo, "拍照", 0, false, FileTypeEnum.PHOTO))
        fileOperation.add(Operation(R.drawable.take_image, "图库", 1, false, FileTypeEnum.IMAGE))
        fileOperation.add(Operation(R.drawable.take_video, "录制视频", 2, false, FileTypeEnum.VIDEO))
        fileOperation.add(Operation(R.drawable.take_audio, "录制音频", 3, false, FileTypeEnum.AUDIO))
        //  fileOperation.add(Operation(R.drawable.file, "文件", 3, false, FileUtils.TYPE.FILE))

        headOperation.add(Operation(R.drawable.icon_take_photo, "拍照", 0, false, FileTypeEnum.PHOTO))
        headOperation.add(Operation(R.drawable.take_image, "图库", 1, false, FileTypeEnum.IMAGE))

        imageOperation.add(Operation(R.drawable.icon_take_photo, "拍照", 0, false, FileTypeEnum.PHOTO))
        imageOperation.add(Operation(R.drawable.take_image, "图库", 1, false, FileTypeEnum.IMAGE))
