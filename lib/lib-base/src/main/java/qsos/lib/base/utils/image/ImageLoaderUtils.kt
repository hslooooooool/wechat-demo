...
object ImageLoaderUtils {
    ...
    private var LOADING: Int = R.drawable.ic_photo2
    private var ERROR: Int = R.drawable.ic_photo2
    ...
    /**加载APP资源图片*/
    fun display(context: Context, imageView: ImageView?, @DrawableRes drawable: Int) {
        if (imageView == null) {
            return
        }
        GlideApp.with(context)
    ...
    /**加载APP资源图片*/
    fun displayRounded(context: Context, imageView: ImageView?, @DrawableRes drawable: Int) {
        if (imageView == null) {
            return
        }
        GlideApp.with(context)
