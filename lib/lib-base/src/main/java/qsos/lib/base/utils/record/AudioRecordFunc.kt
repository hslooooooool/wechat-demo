...
object AudioRecordFunc {
    ...
    val recordFileSize: Long = AudioFileUtils.getFileSize(mNewAudioName)
    ...
    fun stopRecordAndFile(): RecordStateEnum {
        ...
        audioRecord?.release()
        audioRecord = null
        return mRecordStateEnum
    }

    private fun createAudioRecord() {
        // 获取音频文件路径
        mAudioName = AudioFileUtils.rawFilePath
    ...
    private fun writeDateTOFile() {
        ...
        while (mRecordStateEnum == RecordStateEnum.START) {
